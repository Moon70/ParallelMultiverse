...
public class TurnbarYA extends Turnbar{

	public TurnbarYA(Bob bob,Sinatra sinatraMove1,Sinatra sinatraMove2,int positionOffset,boolean fade) {
		this.bob=bob;
	...
	public void render() {
		...
		for(int y=0;y<Screen.screenSizeY;y++) {
			...
			bobDataFrame+=sinatraAnim2.getNextDeltaValue(1);
			bobDataFrame+=+32;
